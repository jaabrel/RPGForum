...
namespace RPGForum.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = await _signInManager.UserManager.FindByEmailAsync(Input.Email) ?? await _signInManager.UserManager.FindByNameAsync(Input.Email);
                if (user != null)
                {
                ...
                ModelState.AddModelError(string.Empty, "Tentativa de início de sessão inválida.");
                return Page();
            }
